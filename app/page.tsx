  ...
  const hackathons: Hackathon[] = [
    {
      ...
      description: 'National-level initiative fostering innovation and problem-solving for societal challenges using technology.',
    ...
    },
    {
      ...
      organizer: 'MumbaiHacks Community',
      location: 'Mumbai, Maharashtra',
      price: 'Free',
      deadline: 'Nov 20, 2025',
      description: 'India\'s vibrant hackathon uniting 3,000+ innovators to build solutions for urban and tech challenges.',
      date: 'November 28-29, 2025',
      prizes: '₹50 Lakh in cash & gadgets',
      themes: ['FinTech', 'Smart City', 'EdTech'],
    },
    {
      id: 3,
      ...
      price: '₹500',
      deadline: 'Dec 1, 2025',
      description: 'Annual tech festival hackathon at IIT Bombay, focusing on cutting-edge engineering and innovation.',
      date: 'December 14-15, 2025',
      prizes: '₹25 Lakh grand prize',
      themes: ['Robotics', 'Blockchain', 'AR/VR'],
    },
  ];
  ...
  const participants = [
    {
      ...
      bio: 'Full-stack developer passionate about building scalable web apps for social impact. Experienced in hackathon wins.',
      experience: '3 years',
    ...
    },
    {
      ...
      bio: 'AI enthusiast specializing in predictive models for agriculture and healthcare. Eager for collaborative hack projects.',
      experience: '2 years',
  ...
  const projects = [
    {
      ...
      type: 'Mobile App',
      tags: ['AI', 'Agriculture'],
      description: 'IoT-based crop monitoring and yield prediction app for Indian farmers',
      progress: '3/5',
    },
    {
      id: 2,
      name: 'SwachhCity',
      type: 'Web App',
      tags: ['Sustainability', 'ML'],
      description: 'Smart waste management platform optimizing collection in Indian cities',
      progress: '2/4',
    },
    {
      id: 3,
      ...
      type: 'VR App',
      tags: ['VR', 'EdTech'],
      description: 'Virtual classroom collaboration tool for remote learning in rural India',
      progress: '1/6',
    },
  ];
